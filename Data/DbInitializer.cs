...
namespace ContosoUniversity.Data
{
  public static class DbInitializer
  {
    public static void Initialize(AngularContosoContext context)
    {
      ...
      {
new Student { FirstName = "Carson", LastName = "Alexander", DateEnrolled = DateTime.Parse("2010-09-01") },
new Student { FirstName = "Meredith", LastName = "Alonso", DateEnrolled = DateTime.Parse("2012-09-01") },
new Student { FirstName = "Arturo", LastName = "Anand", DateEnrolled = DateTime.Parse("2013-09-01") },
new Student { FirstName = "Gytis", LastName = "Barzdukas", DateEnrolled = DateTime.Parse("2012-09-01") },
new Student { FirstName = "Yan", LastName = "Li", DateEnrolled = DateTime.Parse("2012-09-01") },
new Student { FirstName = "Peggy", LastName = "Justice", DateEnrolled = DateTime.Parse("2011-09-01") },
new Student { FirstName = "Laura", LastName = "Norman", DateEnrolled = DateTime.Parse("2013-09-01") },
new Student { FirstName = "Nino", LastName = "Olivetto", DateEnrolled = DateTime.Parse("2005-09-01") }
      };
